...
const plans = [
  {
    ...
    price: 'KES 1,000',
    description: 'Small businesses. 1 Admin + 1 Cashier. Core modules. 15-Day Trial.',
    features: [
      '1 Admin account',
      '1 Cashier account',
  ...
  },
  {
    ...
    price: 'KES 1,500',
    description: 'Growing companies. Multiple Admins + Multiple Cashiers. Advanced reports. 15-Day Trial.',
    features: [
