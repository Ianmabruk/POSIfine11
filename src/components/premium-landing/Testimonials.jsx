  ...
  return (
    <section id="testimonials" className="relative py-24 bg-cream-50 overflow-hidden">
      ...
      <div className="relative">
        <div className="testimonials-grid grid grid-cols-1 gap-4 px-4 sm:px-6 lg:px-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="w-full bg-white rounded-3xl border border-cream-200 p-6 hover:shadow-xl hover:shadow-cream-300/50 transition-all duration-300"
            >
        ...
        <motion.div
          ...
          className="testimonials-marquee flex gap-6 px-4 sm:px-6 lg:px-8"
        ...
        >
          {[...testimonials, ...testimonials].map((testimonial, index) => (
            <motion.div
              ...
              className="w-[280px] sm:w-[350px] flex-shrink-0 bg-white rounded-3xl border border-cream-200 p-6 hover:shadow-xl hover:shadow-cream-300/50 transition-all duration-300"
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-br from-accent-500 to-orange-600 rounded-full opacity-60" />
