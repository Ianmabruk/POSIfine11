        ...
        >
          {[...testimonials, ...testimonials].map((testimonial, index) => (
            <motion.div
              ...
              className="w-[350px] flex-shrink-0 glass-card p-6 rounded-3xl hover:shadow-premium transition-all duration-300"
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-br from-primary-500 to-brand-500 rounded-full opacity-60" />
                  <img
