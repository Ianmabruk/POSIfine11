...
export default function Navbar() {
  ...
  return (
    <motion.nav
      animate={{
        backgroundColor: scrolled ? "rgba(15, 23, 42, 0.72)" : "transparent",
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="px-5 py-2.5 text-sm font-semibold rounded-xl bg-gradient-to-r from-primary-500 to-blue-500 text-white shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40 transition-all duration-300"
            >
              Start Free Trial
            </motion.button>
          </div>
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-white/10 space-y-3">
                <button
                  ...
                  className="w-full text-left text-slate-300 hover:text-white font-medium py-2 transition-colors duration-300"
                >
                  Login
                </button>
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-5 py-3 text-center font-semibold rounded-xl bg-gradient-to-r from-primary-500 to-blue-500 text-white shadow-lg shadow-primary-500/25"
                >
                  Start Free Trial
                </motion.button>
              </div>
