                  ...
                  {filteredStaff.map((member) => (
                    <div key={member.id} className="bg-white rounded-xl shadow p-4 space-y-2 border border-gray-100">
                      ...
                      <div className="flex items-center justify-between text-sm pt-2 border-t border-gray-100">
                        ...
                        <span className="px-2 py-1 text-xs font-semibold rounded-full bg-amber-100 text-amber-800">{member.business_role || member.role}</span>
                      </div>
                      <div className="flex gap-2 pt-2">
                        <button className="text-sm text-amber-600 hover:text-amber-700 font-medium flex-1">Edit</button>
